package MavenProjectGR.repository;
    ...
    private void LoadClient(){
        try{
            ...
            while((line = br.readLine()) != null){
                ...
                String address = line.substring(i1+2,i4);
                String id = line.substring(i4+2);
        ...
        try{
            ...
            while((line = br.readLine()) != null){
                if(b){
                    ...
                    int i3 = line.indexOf(",", i2+1);
                    int i4 = line.indexOf(",", i3+1);
                    address = line.substring(i1+2,i4);
                    id = line.substring(i4+2);
                    b = false;
                }else{
                    int i = line.indexOf(",");
